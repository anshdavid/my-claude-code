...
robust core code for serious extensions
...
14. Deep technical recommendation for Elixir implementation
...
15. Suggested internal package/module layout
    lib/
    claw/
    application.ex
    repo.ex
...
3. Running dangerous tools inline
...
21. My recommended architecture in one sentence
...
learned preferences if appropriate

8. Teams mode like Claude
...
12. Shared memory in teams mode
...
4. Tool access inheritance without checks
...
28. The simplest one-sentence definition
...
Step 7
approvals and safer write tools
